 ...
 */
final class Version20191125160721 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, city VARCHAR(191) NOT NULL, country VARCHAR(191) NOT NULL, created_at DATETIME NOT NULL, images LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', views INT DEFAULT NULL, INDEX IDX_5A8A6C8DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
